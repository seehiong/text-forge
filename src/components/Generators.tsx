...
import { Hash, Key, Settings } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h3 className="font-medium text-gray-900 dark:text-gray-100">UUID Generator</h3>
        </div>
      ...
      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h3 className="font-medium text-gray-900 dark:text-gray-100">Password Generator</h3>
        </div>
      ...
      <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
        <div className="flex items-start space-x-2">
          <Settings className="w-4 h-4 text-green-600 dark:text-green-400 mt-0.5" />
          <div>
